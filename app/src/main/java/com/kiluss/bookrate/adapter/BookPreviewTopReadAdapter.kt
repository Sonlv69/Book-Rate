...
class BookPreviewTopReadAdapter(
    private val bookLists: List<TopRead>,
    private val context: Context,
    private val bookPreviewAdapterInterface: BookPreviewAdapterInterface
) : RecyclerView.Adapter<BookPreviewTopReadAdapter.BookPreviewHolder>() {
    ...
    inner class BookPreviewHolder(
        ...
        fun bindView(bookModel: TopRead) {
            ...
            binding.tvPublishTime.text = "${bookModel.read} read"
